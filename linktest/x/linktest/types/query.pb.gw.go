...
var (
	pattern_Query_Quote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"lajosdeme", "linktest", "quote", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_QuoteAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"lajosdeme", "linktest", "quote"}, "", runtime.AssumeColonVerbOpt(true)))
)
